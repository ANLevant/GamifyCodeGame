...
unrealRootPath=/home/levant/Documents/UnrealEngine/UnrealEngine-release
JavaCompilerTestRootPath=/home/levant/Documents/Unreal Projects/JavaCompilerTest

gameProjectFile=/home/levant/Documents/Unreal Projects/JavaCompilerTest/JavaCompilerTest.uproject
...
include(JavaCompilerTestSource.pri)
include(JavaCompilerTestHeader.pri)
include(JavaCompilerTestConfig.pri)
include(JavaCompilerTestIncludes.pri)
include(JavaCompilerTestDefines.pri)

JavaCompilerTest-Linux-Debug.commands = $$build JavaCompilerTest Linux Debug  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTest-Linux-DebugGame.commands = $$build JavaCompilerTest Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTest-Linux-Shipping.commands = $$build JavaCompilerTest Linux Shipping  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTest-Linux-Test.commands = $$build JavaCompilerTest Linux Test  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTest.commands = $$build JavaCompilerTest Linux Development  -project="\"$$gameProjectFile\"" $$args

JavaCompilerTestEditor-Linux-Debug.commands = $$build JavaCompilerTestEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTestEditor-Linux-DebugGame.commands = $$build JavaCompilerTestEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTestEditor-Linux-Shipping.commands = $$build JavaCompilerTestEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTestEditor-Linux-Test.commands = $$build JavaCompilerTestEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
JavaCompilerTestEditor.commands = $$build JavaCompilerTestEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	JavaCompilerTest-Linux-Debug \
	JavaCompilerTest-Linux-DebugGame \
	JavaCompilerTest-Linux-Shipping \
	JavaCompilerTest-Linux-Test \
	JavaCompilerTest \
	JavaCompilerTestEditor-Linux-Debug \
	JavaCompilerTestEditor-Linux-DebugGame \
	JavaCompilerTestEditor-Linux-Shipping \
	JavaCompilerTestEditor-Linux-Test \
	JavaCompilerTestEditor \
