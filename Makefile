...
JavaCompilerTest-Linux-Debug:
	 $(PROJECTBUILD) JavaCompilerTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTest-Linux-DebugGame:
	 $(PROJECTBUILD) JavaCompilerTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTest-Linux-Shipping:
	 $(PROJECTBUILD) JavaCompilerTest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTest-Linux-Test:
	 $(PROJECTBUILD) JavaCompilerTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTest:
	 $(PROJECTBUILD) JavaCompilerTest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTestEditor-Linux-Debug:
	 $(PROJECTBUILD) JavaCompilerTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) JavaCompilerTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTestEditor-Linux-Shipping:
	 $(PROJECTBUILD) JavaCompilerTestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTestEditor-Linux-Test:
	 $(PROJECTBUILD) JavaCompilerTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

JavaCompilerTestEditor:
	 $(PROJECTBUILD) JavaCompilerTestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
